...
from build.gen.dedup import duplicate_pb2
from build.gen.dedup.duplicate_pb2 import Duplicate
from rb_crawler.constant import SCHEMA_REGISTRY_URL, BOOTSTRAP_SERVER, TOPIC3
...
class RbProducerD:
    def __init__(self):
        ...
        protobuf_serializer = ProtobufSerializer(
            duplicate_pb2.Duplicate, schema_registry_client, {"use.deprecated.format": True}
        )
